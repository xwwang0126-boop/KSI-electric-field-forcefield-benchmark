...
cx=crd(1,1942)  !res_atom(155))
cy=crd(2,1942)  !res_atom(155))
cz=crd(3,1942)  !res_atom(155))
nx=crd(1,1943)  !res_atom(155)+1)
ny=crd(2,1943)  !res_atom(155)+1)
nz=crd(3,1943)  !res_atom(155)+1)
vsx=nx-cx
vsy=ny-cy
vsz=nz-cz
...
do i=1,patom
  if(i.ge.1938.and.i.le.1945)cycle
  if(i.ge.1958.and.i.le.1965)cycle
